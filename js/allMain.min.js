...
$jscomp.polyfill("Array.prototype.find",function(a){return a?a:function(a,c){return $jscomp.findInternal(this,a,c).v}},"es6","es3");var DBHelper=function(){};DBHelper.fetchRestaurants=function(a){fetch(DBHelper.DATABASE_URL).then(function(a){return a.json()}).then(function(b){return a(null,b)}).catch(function(a){console.log(a)})};
...
function loadScript(a,c){var b=document.createElement("script");c&&(b.onload=c);document.getElementsByTagName("head")[0].appendChild(b);b.src=a}var mapUrl="https://maps.googleapis.com/maps/api/js?key\AIzaSyBk90grmxAIQ5LR6qz92rzHtiAEARi4ZHY\x26libraries\x3dplaces";function initializeMap(){loadScript(mapUrl,function(){map=new google.maps.Map(document.getElementById("map"),{zoom:12,center:{lat:40.722216,lng:-73.987501},scrollwheel:!1});updateRestaurants()})}
